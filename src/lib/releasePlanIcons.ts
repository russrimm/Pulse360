// Shared mapping of product/service names to icon asset paths
// Kept minimal; add new mappings here for reuse across release plan components.
export const releasePlanServiceIcons: Record<string, string> = {
