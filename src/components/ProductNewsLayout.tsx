...
function AuthorButton({ author, title, slug }: { author: string; title?: string; slug: string }) {
  ...
  const isJudson = author
    .toLowerCase()
    .replace(/[^a-z]/g, '')
    .includes('judsonalthoff');
  return (
    <Link
    ...
    >
      <span className="w-full text-center font-medium leading-tight block flex items-center justify-center gap-2">
        {isJudson && (
          <Image
            src="/judsonalthoff.webp"
            alt="Judson Althoff"
            width={36}
            height={36}
            className="rounded-full object-cover shrink-0 mr-1"
          />
        )}
        {decodeHtmlEntities(author)}
      </span>
      {title && (
        <span className="w-full text-center block text-[10px] text-gray-600 dark:text-gray-300 leading-tight break-words whitespace-normal">
...
const fabricPaths = ['/product-news/fabric-blog', '/product-news/power-bi'];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 mb-2 w-full overflow-x-hidden">
            ...
            {products.map(product => (
              <Link
                ...
                className={`flex flex-row items-center justify-center gap-2 px-2.5 py-1 rounded-lg border transition-all duration-200 h-10 w-full hover:bg-primary-50/80 active:scale-95 transition-all
                  ${
                    product.href === '/product-news/microsoft-news' &&
                    (pathname === '/product-news/microsoft-news' ||
                      pathname.startsWith('/product-news/author/'))
                      ...
                      : product.href === '/product-news/azure-ai-foundry' &&
                          [
                        ...
                        ? 'bg-primary-50 border-primary-300 dark:bg-primary-900/50 dark:border-primary-700 shadow-sm ring-1 ring-primary-200 dark:ring-primary-800'
                        : product.href === '/product-news/power-platform' &&
                            powerPlatformPaths.includes(pathname)
                          ? 'bg-primary-50 border-primary-300 dark:bg-primary-900/50 dark:border-primary-700 shadow-sm ring-1 ring-primary-200 dark:ring-primary-800'
                          : product.href === '/product-news/fabric-blog' &&
                              fabricPaths.includes(pathname)
                            ? 'bg-primary-50 border-primary-300 dark:bg-primary-900/50 dark:border-primary-700 shadow-sm ring-1 ring-primary-200 dark:ring-primary-800'
          ...
          <div
            className={`hidden lg:block w-full pb-1 mb-10${!['/product-news/power-platform', '/product-news/power-automate', '/product-news/copilot', '/product-news/azure-ai-foundry', '/product-news/all-things-azure', '/product-news/semantic-kernel', '/product-news/fabric-blog', '/product-news/power-bi', '/product-news/vscode', '/product-news/azure-ai-ml', '/product-news'].includes(pathname) ? ' mb-12' : ''}`}
          >
              ...
              <div className="bg-gray-50/70 dark:bg-gray-800/40 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/50 shadow-sm animate-in slide-in-from-top-2 duration-300 max-w-fit mx-auto">
                <div className="flex flex-wrap gap-2 justify-center sm:flex-nowrap">
                  {[
                    ...
                    >
                      <span className="text-primary-500 dark:text-primary-400 text-[10px] mr-1">
                        →
                      </span>
                      <Image
                        src={product.icon}
              ...
              <div className="bg-gray-50/70 dark:bg-gray-800/40 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/50 shadow-sm animate-in slide-in-from-top-2 duration-300 max-w-fit mx-auto">
                <div className="flex flex-wrap gap-2 justify-center sm:flex-nowrap">
                  {[
                    ...
                    {
                      name: 'VS Code',
                      icon: '/icons/azure/devops/VisualStudioCode.svg',
                      href: '/product-news/vscode',
                    },
                  ].map((product, index) => (
                    <Link
                      key={product.name}
          ...
          {(pathname === '/product-news/microsoft-news' ||
            pathname.startsWith('/product-news/author/')) && <AuthorButtons />}
...
function isProductPathActive(productHref: string, pathname: string): boolean {
  if (productHref === '/product-news/microsoft-news') {
    return pathname === productHref || pathname.startsWith('/product-news/author/');
  }
  if (productHref === '/product-news/azure-ai-foundry') {
    return [
      '/product-news/azure-ai-foundry',
      '/product-news/all-things-azure',
      '/product-news/semantic-kernel',
  ...
  if (productHref === '/product-news/power-platform') {
    return powerPlatformPaths.includes(pathname);
  }
  if (productHref === '/product-news/fabric-blog') {
    return fabricPaths.includes(pathname);
  }
  return pathname === productHref;
}
