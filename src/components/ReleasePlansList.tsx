                  ...
                  <div className="p-4 flex flex-col gap-2">
                    ...
                    {selectedDateFilter === 'custom' && (
                      <div className="flex flex-col gap-2 mt-2">
                        <div>
                          <label htmlFor="date-from" className="block text-sm text-gray-700 dark:text-gray-200 mb-1">From</label>
                          <input
                            id="date-from"
                            type="date"
                            value={customDateRange.from}
                            onChange={e => setCustomDateRange({ ...customDateRange, from: e.target.value })}
                            className="w-full border rounded px-2 py-1 text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600"
                          />
                        </div>
                        <div>
                          <label htmlFor="date-to" className="block text-sm text-gray-700 dark:text-gray-200 mb-1">To</label>
                          <input
                            id="date-to"
                            type="date"
