import { getPowerPlatformNews } from '@/lib/api';
import { ProductNewsCard } from '@/components/ProductNewsCard';
import Image from 'next/image';
import Link from 'next/link';

export const metadata = {
  title: 'Power Platform News | MCViewer',
...
export default async function PowerPlatformNewsPage() {
  const news = await getPowerPlatformNews();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Stay up to date with the latest news and announcements from Microsoft Power Platform.
          </p>
        </div>
