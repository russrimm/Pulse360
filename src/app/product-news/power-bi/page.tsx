...
export const metadata = {
  title: 'Power BI News | MCViewer',
  description: 'Stay up to date with the latest news and announcements from Microsoft Power BI.',
};
...
export default async function PowerBINewsPage() {
  const news = await getPowerBINews();
